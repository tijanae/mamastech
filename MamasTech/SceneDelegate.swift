...
//  MamasTech
//
//  Created by Tia Lendor on 11/1/19.
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func createMainTabBarController() -> UITabBarController {
        let firstvc = Service()
        let secondvc = CurrentAppointment()
        let thirdvc  = UserSettings()
        firstvc.tabBarItem = UITabBarItem(title: "Service", image: UIImage(named: "appointment"), tag: 0)
